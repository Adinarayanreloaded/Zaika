...
if(isset($_POST['submit'])){
  ...
  try{
    ...
    $mail->Subject = 'Message Received (Contact Page)';
     $mail->Body = "The order of $name has been placed for booking at Zayka with email id : $email . We will contact you soon with your reserve Table." ; //"<h3>Name :  $name <br>Email: $email <br>Message : $message</h3>";
